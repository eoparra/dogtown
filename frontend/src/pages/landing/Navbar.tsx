        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <a href="#" className="flex items-center gap-2 group">
            ...
            <span className={`font-heading font-extrabold text-xl transition-colors ${
              scrolled ? 'text-dogtown-brown' : 'text-dogtown-brown'
            }`}>
              DogTown
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className={`font-heading font-semibold text-sm tracking-wide transition-colors hover:text-dogtown-orange ${
                  scrolled ? 'text-dogtown-brown/70' : 'text-dogtown-brown/70'
                }`}
              >
                {link.label}
              </a>
